...
public class Main {
    private static final String INITIAL_FILE = "./src/main/resources/home21/inout/initialFile.txt";
    private static final String REVERSED_FILE = "./src/main/resources/home21/inout/reversedFile.txt";
